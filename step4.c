...
int step4(inst i, int r, int s)
{
    ...
    cells[1] = calloc((2+global_grid.n/instance.p)*(2+global_grid.m/instance.q),sizeof(cell2));
    cells[0] = calloc((2+global_grid.n/instance.p)*(2+global_grid.m/instance.q),sizeof(cell2));
